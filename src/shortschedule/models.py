...
class ObservationSequence:
    ...
    def __init__(self, id, target, priority, start_time, stop_time, ra, dec, payload_params):
        self.id = id
        self.target = target
    ...
    def get_nested_payload_parameter(self, category, parameter_name, sub_parameter_name, default=None):
...
class Visit:
    ...
    def total_duration_minutes(self):
        ...
        return self.total_duration.sec / 60.
...
class ScienceCalendar:
    ...
    def priority_breakdown(self):
        ...
        for visit in self.visits:
            for seq in visit.sequences:
                ...
                breakdown[priority]['duration_minutes'] += (seq.duration.sec/60)
    ...
    def __repr__(self):
        return (f"<ScienceCalendar: {len(self.visits)} visits, "
